...
# ponytail: keep dependencies minimal and package cleanups to reduce image size
...
# Enable Apache rewrite module and configure Directory permissions for symlinked storage
RUN a2enmod rewrite
